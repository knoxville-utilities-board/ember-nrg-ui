...
module('Integration | Component | nrg-dropdown', function(hooks) {
  ...
  test('block templating works', async function(assert) {
    ...
    assert.equal(this.$('.text').text().trim(), 'Label2 2');
  });
